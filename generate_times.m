function times = generate_times(Settings)
    names = {'AcquireFP', 'FPHold', 'TGOnToFPOff','TGOnToTGOff','TGOffToFPOff', 'ResponseWindow', 'MaximumSaccade', 'TGHoldToReward', 'InterTrialInterval', 'RewardDuration', 'InvalidTimeout'};
